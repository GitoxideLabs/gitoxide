...
### Chore
 ...
 - <csr-id-c3e19283df5f3496443eb8e28401a4d26697df88/> remove the unnecessary `symlink` dependency in favor of `gix-fs`.
...
### New Features
 ...
 - <csr-id-a89272d72c2656265e163cc2981a57b732f655db/> allow worktree stacks to reject terminal symlinks on Windows
 ...
 * **Uncategorized**
    ...
    - Allow worktree stacks to reject terminal symlinks on Windows ([`a89272d`](https://github.com/GitoxideLabs/gitoxide/commit/a89272d72c2656265e163cc2981a57b732f655db))
    - Remove the unnecessary `symlink` dependency in favor of `gix-fs`. ([`c3e1928`](https://github.com/GitoxideLabs/gitoxide/commit/c3e19283df5f3496443eb8e28401a4d26697df88))
