...
pub trait Write {
    ...
    fn write_buf(&self, object: crate::Kind, mut from: &[u8]) -> ExnResult<gix_hash::ObjectId> {
    ...
    fn write_stream(&self, kind: crate::Kind, size: u64, from: &mut dyn io::Read) -> ExnResult<gix_hash::ObjectId>;
