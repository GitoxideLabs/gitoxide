...
### Bug Fixes (BREAKING)
 ...
 - <csr-id-b060eb24a0688fa5649b937052e5f314123bc1a6/> remove `winnow` from the public `gix-actor` API for parsing
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#2545](https://github.com/GitoxideLabs/gitoxide/issues/2545)
 ...
 * **[#2545](https://github.com/GitoxideLabs/gitoxide/issues/2545)**
    - Remove `winnow` from the public `gix-actor` API for parsing ([`b060eb2`](https://github.com/GitoxideLabs/gitoxide/commit/b060eb24a0688fa5649b937052e5f314123bc1a6))
 * **Uncategorized**
    ...
    - Adapt to changes in `gix-error` ([`2e2a126`](https://github.com/GitoxideLabs/gitoxide/commit/2e2a1264b53cda92c00176639225d1b293099350))
</details>
...
### New Features (BREAKING)
 ...
 - <csr-id-2aec23badd6e36d5b6eb34700b067dd1e16acf3f/> remove `thiserror` in favor of `gix-error`
