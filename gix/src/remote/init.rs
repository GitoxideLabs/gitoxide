...
use crate::{Error, Remote, Repository, Result, config, remote};
...
impl<'repo> Remote<'repo> {
    ...
    pub(crate) fn from_fetch_url<Url, E>(url: Url, should_rewrite_urls: bool, repo: &'repo Repository) -> Result<Self>
    where
