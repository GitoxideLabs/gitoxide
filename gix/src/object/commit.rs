...
impl<'repo> Commit<'repo> {
    ...
    /// # Ok(()) }
    /// ```
    pub fn short_id(&self) -> Result<gix_hash::Prefix> {
    ...
    #[cfg(feature = "command")]
    pub fn verify_signature(&self) -> Result<Option<crate::commit::verify::Outcome>> {
    ...
    #[cfg(feature = "command")]
    pub fn signed(&self) -> Result<Commit<'repo>> {
