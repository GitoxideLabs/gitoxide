 ...
 * **Uncategorized**
    ...
    - Merge pull request #2851 from ElectricPulse/main ([`f6e15fe`](https://github.com/GitoxideLabs/gitoxide/commit/f6e15feefe3822b529f852687225e3e9670a0295))
    - Review ([`a939478`](https://github.com/GitoxideLabs/gitoxide/commit/a939478d0bfb13cad31dbfbda1ed9fcde6fb7073))
    - Fixed github issue #2850 ([`d8ed5a3`](https://github.com/GitoxideLabs/gitoxide/commit/d8ed5a3ecba10cf017be4506ea423de0c368010c))
...
### Chore
 ...
 - <csr-id-1568b311bfe6babb30330183cb8b8418d23ca94c/> let archived fixtures bypass Git version gates
   <!-- agent -->
...
<csr-read-only-do-not-edit/>
 ...
 - 1 unique issue was worked on: [#1622](https://github.com/GitoxideLabs/gitoxide/issues/1622)
 ...
 * **[#1622](https://github.com/GitoxideLabs/gitoxide/issues/1622)**
    - Let archived fixtures bypass Git version gates ([`1568b31`](https://github.com/GitoxideLabs/gitoxide/commit/1568b311bfe6babb30330183cb8b8418d23ca94c))
 * **Uncategorized**
    ...
    - Merge pull request #2699 from jason5122/fix-kind-worktree-of-natively-bare-repo ([`1ff51ca`](https://github.com/GitoxideLabs/gitoxide/commit/1ff51caaab6ae7e3cd5e2fa84b3280363c2ae70c))
    - Review ([`b36ca4c`](https://github.com/GitoxideLabs/gitoxide/commit/b36ca4ca3d88638aff8d807c69e28ed938f921af))
    - Merge pull request #2682 from GitoxideLabs/improvements ([`f77cb0a`](https://github.com/GitoxideLabs/gitoxide/commit/f77cb0a16bce0cd90862bbf28b87a9883cdb01d9))
    - Add test for non-bare `repo.git` discovery classification ([`767b1c7`](https://github.com/GitoxideLabs/gitoxide/commit/767b1c768a047484b9795244999cb3cac617f021))
...
### Documentation
 ...
 - <csr-id-3cb24ed00ccf39cb08bc56466e56f8ffc55b694e/> improve documentation on `from_plain_file_relative_to_file` and `from_plain_file`
...
### New Features
 ...
 - <csr-id-1ae4465b28940f774866ee434bc7ed6b5c4f4cba/> add support for relative worktree directories

### New Features (BREAKING)

 - <csr-id-c9ebac7eb9a91ee9519a6f78781de57bdb1ed262/> allow assuming trust during upward discovery
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2652 from GitoxideLabs/override-upward-trust ([`52d26d7`](https://github.com/GitoxideLabs/gitoxide/commit/52d26d702ef2d9e1cbc4cac03e7b3b5a57eb087a))
    - Allow assuming trust during upward discovery ([`c9ebac7`](https://github.com/GitoxideLabs/gitoxide/commit/c9ebac7eb9a91ee9519a6f78781de57bdb1ed262))
    - Merge pull request #2623 from GitoxideLabs/followup-2599 ([`1d2d3b4`](https://github.com/GitoxideLabs/gitoxide/commit/1d2d3b4b12140ef6e6fe24c93b5fea0589431098))
    - Improve documentation on `from_plain_file_relative_to_file` and `from_plain_file` ([`3cb24ed`](https://github.com/GitoxideLabs/gitoxide/commit/3cb24ed00ccf39cb08bc56466e56f8ffc55b694e))
    - Merge pull request #2599 from GitoxideLabs/relative-workree-path ([`a209dc1`](https://github.com/GitoxideLabs/gitoxide/commit/a209dc1d292def61244ebae6dd1f5650f73e149c))
    - Add support for relative worktree directories ([`1ae4465`](https://github.com/GitoxideLabs/gitoxide/commit/1ae4465b28940f774866ee434bc7ed6b5c4f4cba))
 ...
 * **Uncategorized**
    ...
    - Cleanup `sha1` feature in `gix` to just set what's needed. ([`16a6fc4`](https://github.com/GitoxideLabs/gitoxide/commit/16a6fc44cf331464ee42c78a9c9ccb07aaf05aa1))
...
### New Features
 ...
 - <csr-id-b16ba7510738f344f9a1b50cdc2aaacbb5674d2d/> Add `path::repository_kind()` and `path::RepositoryKind`
...
### Bug Fixes
 ...
 - <csr-id-a80a150c75f055ffd0f0d9c905760826152fd61e/> discover upwards to cwd
 ...
 * **Uncategorized**
    ...
    - Discover upwards to cwd ([`a80a150`](https://github.com/GitoxideLabs/gitoxide/commit/a80a150c75f055ffd0f0d9c905760826152fd61e))
    - Refactor ([`b3b3203`](https://github.com/GitoxideLabs/gitoxide/commit/b3b32038531347ff36898d6915d3d3627bffde80))
    - Fix discover::upwards when working dir is the repo ([`504afec`](https://github.com/GitoxideLabs/gitoxide/commit/504afece056cbefabbdecea50ba19260ecf4b2c9))
...
### Bug Fixes
 ...
 - <csr-id-59c8a965081303ff6f86607af7b1f66e79f04c93/> repositories using ref-tables will be recognised.
 ...
 * **Uncategorized**
    ...
    - Repositories using ref-tables will be recognised. ([`59c8a96`](https://github.com/GitoxideLabs/gitoxide/commit/59c8a965081303ff6f86607af7b1f66e79f04c93))
    - Add reftable test ([`a74a861`](https://github.com/GitoxideLabs/gitoxide/commit/a74a8615c350e16f1ec55121754b1c9204713488))
 ...
 * **Uncategorized**
    ...
    - Improve error message to be less elusive ([`eb9f9c3`](https://github.com/GitoxideLabs/gitoxide/commit/eb9f9c327f94e59ff72160809e1409bc60629b2f))
    ...
    - Avoid `rm -v` in fixtures for portability ([`e961c13`](https://github.com/GitoxideLabs/gitoxide/commit/e961c132c03b5bc856f71355aaed6d94be226186))
 ...
 * **Uncategorized**
    ...
    - Properly classify non-bare repositories without worktree. ([`208cf5a`](https://github.com/GitoxideLabs/gitoxide/commit/208cf5a663da9728da98ff6be30534049ae38568))
    - New layout for integration tests ([`85e18d2`](https://github.com/GitoxideLabs/gitoxide/commit/85e18d21534d31791df0f43335c36deeb16996c4))
 ...
 * **Uncategorized**
    ...
    - Update a regenerated archive specific to macOS ([`c31c175`](https://github.com/GitoxideLabs/gitoxide/commit/c31c1754b48d50a5f17cb670914319e48c816ab4))
 ...
 * **Uncategorized**
    ...
    - Remove reset of `match_ceiling_dir_or_error` in `apply_environment()` ([`85499e4`](https://github.com/GitoxideLabs/gitoxide/commit/85499e4ffd5cd0e66189bc3154d3046432fc05eb))
 ...
 * **Uncategorized**
    ...
    - Make repositories with `worktree` config work. ([`e9295dc`](https://github.com/GitoxideLabs/gitoxide/commit/e9295dc7a98eaedddb6941daa39b80412164360d))
</details>
 ...
 * **[#980](https://github.com/GitoxideLabs/gitoxide/issues/980)**
    - `bare()` can now make sure it detects bare repos, at an expense. ([`169228b`](https://github.com/GitoxideLabs/gitoxide/commit/169228b12f826135d27fd674acbca932b2691a91))
 * **Uncategorized**
 ...
 * **Uncategorized**
    ...
    - Make it possible to discover a bare repository with an index file. ([`9626770`](https://github.com/GitoxideLabs/gitoxide/commit/96267708958ead2646aae8766a50fa060739003c))
</details>
 ...
 * **Uncategorized**
    ...
    - `discover_opts` supports an option to see non-bare repos only. ([`1b8d9e6`](https://github.com/GitoxideLabs/gitoxide/commit/1b8d9e6a408e480ae1912e919c37a26e5c46639d))
    - Common-dir is now queried only when needed. ([`abbae1c`](https://github.com/GitoxideLabs/gitoxide/commit/abbae1cbca6fb5c4347e51f7122f02d106c8d30a))
    - Avoid redundant metadata queries for directories ([`f36abd5`](https://github.com/GitoxideLabs/gitoxide/commit/f36abd57ff0719edc2c95058832ef57ff8c53bba))
    - Speedup HEAD detection in `is_git()` ([`7613249`](https://github.com/GitoxideLabs/gitoxide/commit/761324953a20d061f859c995180d603bb3734f9a))
    - Try `.git` subdir early for higher chances of success. ([`7543fab`](https://github.com/GitoxideLabs/gitoxide/commit/7543fab01c337c086c7b1331ad5fb1d48f9d11ac))
    - Merge branch 'fix-823' ([`6ebd61e`](https://github.com/GitoxideLabs/gitoxide/commit/6ebd61e548a36a04e413ac725a03e607a3588334))
    - Add test to assure we can handle bare repos with `index` file. ([`a68692b`](https://github.com/GitoxideLabs/gitoxide/commit/a68692b5bfb8082f07dd907b091240106c6b358e))
 ...
 * **Uncategorized**
    ...
    - Merge branch '771_missing_negtive_in_error_message_returned_by_gix_discover' ([`7f6e67d`](https://github.com/GitoxideLabs/gitoxide/commit/7f6e67d1339b9b9548d5ea012954c9e45588af9d))
    - Add missing 'not' in error messages ([`61ee905`](https://github.com/GitoxideLabs/gitoxide/commit/61ee9057f38d53d7cd4317503625359023747725))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 10 unique issues were worked on: [#301](https://github.com/GitoxideLabs/gitoxide/issues/301), [#331](https://github.com/GitoxideLabs/gitoxide/issues/331), [#426](https://github.com/GitoxideLabs/gitoxide/issues/426), [#427](https://github.com/GitoxideLabs/gitoxide/issues/427), [#429](https://github.com/GitoxideLabs/gitoxide/issues/429), [#450](https://github.com/GitoxideLabs/gitoxide/issues/450), [#470](https://github.com/GitoxideLabs/gitoxide/issues/470), [#482](https://github.com/GitoxideLabs/gitoxide/issues/482), [#544](https://github.com/GitoxideLabs/gitoxide/issues/544), [#691](https://github.com/GitoxideLabs/gitoxide/issues/691)
 ...
 * **[#301](https://github.com/GitoxideLabs/gitoxide/issues/301)**
    ...
    - A test to assure non-existing worktree directories don't hinder discovery ([`131481c`](https://github.com/GitoxideLabs/gitoxide/commit/131481cac26959d46f62d40adcfc895faa4a1698))
    - Allow discovery of linked worktree git dirs ([`050f795`](https://github.com/GitoxideLabs/gitoxide/commit/050f795bfb0fe11655cd7e45c10d87c89ba82625))
    - Path shortening now calculates the actual path length, not just component count ([`c0d24e0`](https://github.com/GitoxideLabs/gitoxide/commit/c0d24e0fb422f990213606d781ba056c238bd70b))
    - Adjust to changes in git-path ([`a627ddc`](https://github.com/GitoxideLabs/gitoxide/commit/a627ddc48be034f8a42d86edf2a9295299297d59))
    - Adapt to changes in git-path ([`c258d77`](https://github.com/GitoxideLabs/gitoxide/commit/c258d77660755559eaa5389bfabe0cebdf478a80))
    - Refactor ([`81a542f`](https://github.com/GitoxideLabs/gitoxide/commit/81a542fbb680a19322877cf3740ae2ae66b95011))
    - Rely on `absolutize_components()` ([`e844006`](https://github.com/GitoxideLabs/gitoxide/commit/e84400660dad6281fe3869ad649470f2adf31979))
    - Brutally fix path handling of common dirs ([`e120232`](https://github.com/GitoxideLabs/gitoxide/commit/e120232252875cd3fdacb9b7df90c3db58e7e24e))
    - Another test to assure invalid worktree dirs aren't git dirs ([`e6e3608`](https://github.com/GitoxideLabs/gitoxide/commit/e6e3608490bda2577c23f93d905a51c33fa4f777))
    ...
    - Fix tests on windows ([`8080ad2`](https://github.com/GitoxideLabs/gitoxide/commit/8080ad2baedf83237a0d9a01550582fc8592e568))
    - Better tests for worktree discovery ([`9d0f134`](https://github.com/GitoxideLabs/gitoxide/commit/9d0f134b3186635cbc253464fc7cec2ff522a4e2))
    - The first working version of worktree detection ([`dc73e96`](https://github.com/GitoxideLabs/gitoxide/commit/dc73e96fdd21713083d9fe0464d1a5689405c116))
    - Fix windows tests ([`b025008`](https://github.com/GitoxideLabs/gitoxide/commit/b0250080c5a1e8ba3fbdb3f70038521b75634306))
    - Refactor ([`6b73e0d`](https://github.com/GitoxideLabs/gitoxide/commit/6b73e0dc60488fcadf21366322e75f711bada6f4))
    - Support for gitdir file parsing with all of gits safety ([`1223fc7`](https://github.com/GitoxideLabs/gitoxide/commit/1223fc7777f57d73c3693407f6a1e41393919a99))
    - Basic parsing for git-dir files ([`e11c677`](https://github.com/GitoxideLabs/gitoxide/commit/e11c67770c301942188f204dbb2cd61880087959))
    - Fix test on windows maybe ([`9583048`](https://github.com/GitoxideLabs/gitoxide/commit/95830480928421de1e38c99a7e9a65629ec1cc41))
    - Try to fix winodws build ([`f2c5ed3`](https://github.com/GitoxideLabs/gitoxide/commit/f2c5ed3326a3076cc25afbaeec9a540d823e0606))
    - Refactor `repositoryKind` adjusted to handle linked worktrees ([`84677cb`](https://github.com/GitoxideLabs/gitoxide/commit/84677cb09634e1d18ce20850bb7c6c9d63a13818))
    - Refactor ([`eead214`](https://github.com/GitoxideLabs/gitoxide/commit/eead2144e10b96e997cd702cb651f4c92693df95))
    - Avoid running failing test on _any_ windows ([`9351a3d`](https://github.com/GitoxideLabs/gitoxide/commit/9351a3db2a7e9da13be3071c1d2d5aa0cb7a35b6))
    - Fix tests on windows maybe ([`8084581`](https://github.com/GitoxideLabs/gitoxide/commit/8084581619c7261f779ae42856be756eac7fbfa4))
    - Don't archive repositories with worktrees ([`389ef66`](https://github.com/GitoxideLabs/gitoxide/commit/389ef663ce0417f3840f90dedfc91a57eae6fd0c))
    - Prepare test to provide worktrees of different kinds as well ([`a4cec4a`](https://github.com/GitoxideLabs/gitoxide/commit/a4cec4ab8ba80a8f439b283d369d48cdafbe7b74))
    - Add required support for reading path files ([`bc08511`](https://github.com/GitoxideLabs/gitoxide/commit/bc085116241e8824c623efc9893ded220fe9a5a2))
    - Remove handling of environment variables ([`4e914f8`](https://github.com/GitoxideLabs/gitoxide/commit/4e914f89bbf04dbe55eae01f7be09899296ad8b0))
    - Add git-discover to check-size ([`85b29a6`](https://github.com/GitoxideLabs/gitoxide/commit/85b29a6ba6b3ee4b925fd10c688b2aabcf4273f2))
    - Fix docs ([`1e3acd0`](https://github.com/GitoxideLabs/gitoxide/commit/1e3acd08b9df9fe0cc36bb6a4d4bac57c365443d))
    - Refactor ([`00a988e`](https://github.com/GitoxideLabs/gitoxide/commit/00a988e3c2c964447f675164a6126bf6cb470c6b))
    - Migrate all relevant code from git-repository to git-discover ([`631e70e`](https://github.com/GitoxideLabs/gitoxide/commit/631e70e6f210df40eb789023970ec17095ec3556))
    - Add empty git-discover crate ([`6565f16`](https://github.com/GitoxideLabs/gitoxide/commit/6565f163ba464f5adf63d214143a4e12f48b00fc))
 * **[#331](https://github.com/GitoxideLabs/gitoxide/issues/331)**
    - Add `DOT_GIT_DIR` constant, containing the name ".git". ([`0103501`](https://github.com/GitoxideLabs/gitoxide/commit/010350180459aec41132c960ddafc7b81dd9c04d))
 ...
 * **[#426](https://github.com/GitoxideLabs/gitoxide/issues/426)**
    - Allow tests to deal with shared drives by adjusting trust expectation ([`85ab096`](https://github.com/GitoxideLabs/gitoxide/commit/85ab0964a1a35556a5efe392576c9b028e601c6c))
    - Cleanup ([`e029eb4`](https://github.com/GitoxideLabs/gitoxide/commit/e029eb4589942e06a53bc0f6ed472d1d33c4a7e6))
 * **[#427](https://github.com/GitoxideLabs/gitoxide/issues/427)**
    ...
    - Turn on performance mode for sha-1 computation ([`44371a1`](https://github.com/GitoxideLabs/gitoxide/commit/44371a10f464f32db346aa6b8309e983cfa20933))
 ...
 * **[#450](https://github.com/GitoxideLabs/gitoxide/issues/450)**
    ...
    - Adapt to changes in `git-sec` ([`0ce21b1`](https://github.com/GitoxideLabs/gitoxide/commit/0ce21b1e95e00f2d4cebc1c62349e0dc66a1c705))
 ...
 * **[#482](https://github.com/GitoxideLabs/gitoxide/issues/482)**
    - Add `is_submodule_git_dir()` ([`2e015a3`](https://github.com/GitoxideLabs/gitoxide/commit/2e015a3874ab4db40449ec4b8ffb126d8e1a22a4))
    - Query the `cwd` only once instead of potentially multiple times, allocating a Vec each time. ([`6be38f2`](https://github.com/GitoxideLabs/gitoxide/commit/6be38f294087f8c5e9bb8522bbf928a761c5cdf0))
    - Provide more details when classifying submodule directories. ([`1b0ef18`](https://github.com/GitoxideLabs/gitoxide/commit/1b0ef1856f542e5dc23310be93c2b39a9d84cb80))
    - Fix windows build ([`ff488fa`](https://github.com/GitoxideLabs/gitoxide/commit/ff488fac628b95ec8f64b136a125913b7b96d3a6))
    - Fix docs ([`3724f31`](https://github.com/GitoxideLabs/gitoxide/commit/3724f31c0563d79a0cad88d773fa60ea21f504b8))
    - `is_git()` now detects submodule worktrees correctly. ([`4a3e1cf`](https://github.com/GitoxideLabs/gitoxide/commit/4a3e1cfbc537963b851c66754e7724875b49b1f4))
    - Refactor ([`1ee9918`](https://github.com/GitoxideLabs/gitoxide/commit/1ee991847a5adeaaeb6e80ae626c28b0ba89e0af))
    - `git_discover::is_git()` can detect submodule dirs correctly enough. ([`aa6fd97`](https://github.com/GitoxideLabs/gitoxide/commit/aa6fd9702e16b4a2bedb0dd0d2323d06133d1a7f))
    - Another test indicating git-discover misclassifies `.git/modules` as worktree ([`9133141`](https://github.com/GitoxideLabs/gitoxide/commit/91331416146afb9e868e0868b47097865d2d7117))
    - Failing test to show discovery skips submodules entirely ([`b56b57c`](https://github.com/GitoxideLabs/gitoxide/commit/b56b57c4111512853e42397ee1fdfd4c11cadf75))
 * **[#544](https://github.com/GitoxideLabs/gitoxide/issues/544)**
    - Fix a test that assumed a non-worktree parent repo. ([`1908229`](https://github.com/GitoxideLabs/gitoxide/commit/190822908d99c7e2f9f118cd1eff80607e4558c4))
 ...
 * **Uncategorized**
    ...
    - Rename `git-discover` to `gix-discover` ([`6e619de`](https://github.com/GitoxideLabs/gitoxide/commit/6e619deb6fd063b7fe524b9e2f837c2168adeaa3))
    ...
    - `GIT_CEILING_DIRECTORIES` now handles UNC paths correctly #(730). ([`07cd4a8`](https://github.com/GitoxideLabs/gitoxide/commit/07cd4a869d22476f812e4dafc847894ddebff5a8))
    ...
    - Search dirs that are equal to ceiling dirs are allowed to 'break through' said ceiling. ([`1a489be`](https://github.com/GitoxideLabs/gitoxide/commit/1a489bee7bb5e9cb168fd2758930dc0b92040dcc))
    - Add test to help understand why it acts the way it does. ([`48057d3`](https://github.com/GitoxideLabs/gitoxide/commit/48057d305b5bddcd6a05a73b80d1c17045b54ade))
    - Ignore cwd as ceiling directory ([`c91ac5b`](https://github.com/GitoxideLabs/gitoxide/commit/c91ac5b0916a2d2e1bb9ca096e50d627f1f6a8f3))
    - Upgrade serial-test to 1.0 ([`9ab3e25`](https://github.com/GitoxideLabs/gitoxide/commit/9ab3e25e4c1ff6d504a79521cfa9453a7e7e7465))
    ...
    - `upwards::Options::apply_environment()` uses a more 'git'-like default setup. ([`7016979`](https://github.com/GitoxideLabs/gitoxide/commit/70169794bc27936382e75e75e18806649630d7cf))
    - Allow ceiling dirs not to match if `apply_environment` is used ([`9b7df62`](https://github.com/GitoxideLabs/gitoxide/commit/9b7df6237611cd1b6328364e6d95c22c99c63ca7))
    - Merge branch 'fix/ceiling-directories-win' ([`78517a6`](https://github.com/GitoxideLabs/gitoxide/commit/78517a616b4b1b6fefc2367057a9b3b786d93750))
    - Make `parse_ceiling_dirs` resilient to illformed UTF-8 ([`8840b64`](https://github.com/GitoxideLabs/gitoxide/commit/8840b649b68dd2ae17e43a61ab04cf866124ef46))
    - Split directories by semicolon on Windows ([`1eddfbd`](https://github.com/GitoxideLabs/gitoxide/commit/1eddfbd22f1d7362f15021897b0a4fecda5f4c3f))
    ...
    - Uprgade serial_test to 0.10 ([`8623b5a`](https://github.com/GitoxideLabs/gitoxide/commit/8623b5a36f3e82cd694f7772798e36656cbfcd0a))
    ...
    - Assure git-discover can recognize a repository without a 'config' file ([`7994416`](https://github.com/GitoxideLabs/gitoxide/commit/79944160f3cad4b977521853e881070f23b7dcc1))
    ...
    - Improve error verbosity when fetching and cloning ([`40f7379`](https://github.com/GitoxideLabs/gitoxide/commit/40f7379b7a89f7fe6f916801384e9e65e5b85c57))
    - Read worktree specific configuration to override the one from the shared repository. ([`d1b7ec6`](https://github.com/GitoxideLabs/gitoxide/commit/d1b7ec605f8016c52c088477b6b0c5adf7ea0ab2))
    - Fix typo in docs ([`2d9b2f1`](https://github.com/GitoxideLabs/gitoxide/commit/2d9b2f16d938e1a4a391534df37f99f1c64c8ea6))
    ...
    - Adjust for changes in `git-path` ([`cf25e35`](https://github.com/GitoxideLabs/gitoxide/commit/cf25e3594b99909defb431f34fb3a4d8a25bd37c))
    ...
    - Add test that actually uses chdir like in the real world. ([`048c8b2`](https://github.com/GitoxideLabs/gitoxide/commit/048c8b260f78ee1eac74bf8f4ee2374d6b0eb308))
    - Refactor ([`cdb9556`](https://github.com/GitoxideLabs/gitoxide/commit/cdb95567c83d52cf93a621bf616883f09f5544bb))
    - Discover repo with relative path and ceiling ([`6fc5c06`](https://github.com/GitoxideLabs/gitoxide/commit/6fc5c06482636540804f7a8fb74794f52c72eda6))
    ...
    - `Path::from_dot_git_dir()` now takes the `current_dir` as argument and returns `Option<path>` ([`b4dcfc7`](https://github.com/GitoxideLabs/gitoxide/commit/b4dcfc716a80ffccbab6f7ccc586d8063cc10fff))
    ...
    - Merge branch 'fix-544' ([`a0dd96b`](https://github.com/GitoxideLabs/gitoxide/commit/a0dd96b509f46e261482eb4027fbbd56380e3afc))
    ...
    - Don't run typically failing MacOS specific test on CI anymore ([`6c9d18b`](https://github.com/GitoxideLabs/gitoxide/commit/6c9d18b1435f28c5ef70371d909cc884eeb6b86a))
    ...
    - Merge branch 'macos-exfat' ([`f256f8f`](https://github.com/GitoxideLabs/gitoxide/commit/f256f8fb7603f83d44acda07386f277c65ac652c))
    - Refactor ([`2cd1c00`](https://github.com/GitoxideLabs/gitoxide/commit/2cd1c007330749f69fc1f154ba1a6e7a0f6e23d0))
    - Test `is_git` on macOS exfat ([`7057ad2`](https://github.com/GitoxideLabs/gitoxide/commit/7057ad2251f76756a5b35b6bbba10ab9b6601226))
    - Allow opening repos on macos exfat ([`08d0c27`](https://github.com/GitoxideLabs/gitoxide/commit/08d0c27b0641526aa8b70ee5aadd3658862bef1b))
    ...
    - Merge branch 'submodule-open' ([`8f5f3ab`](https://github.com/GitoxideLabs/gitoxide/commit/8f5f3ab588cf0165d50a82365119ad5804745017))
    - Thanks clippy ([`2135fb8`](https://github.com/GitoxideLabs/gitoxide/commit/2135fb80a126afc6d95b9eaa9f1cd32acb46615b))
    ...
    - Remove another special case on windows due to canonicalize() ([`61abb0b`](https://github.com/GitoxideLabs/gitoxide/commit/61abb0b006292d2122784b032e198cc716fb7b92))
    ...
    - Refactor ([`ec37cb8`](https://github.com/GitoxideLabs/gitoxide/commit/ec37cb8005fa272aed2e23e65adc291875b1fd68))
    - Refactor ([`b27a8c2`](https://github.com/GitoxideLabs/gitoxide/commit/b27a8c243cdc14730478c2a94cafdc8ccf5c60d3))
    - Refactor ([`06e96a4`](https://github.com/GitoxideLabs/gitoxide/commit/06e96a435d820a1ef1e567bf93e7b9ca5fa74829))
    - Refactor ([`b555bda`](https://github.com/GitoxideLabs/gitoxide/commit/b555bdae9964628b6d43e00dd7d7ee8fe674d309))
    - Unify the way `dir_made_absolute` is computed ([`48417fc`](https://github.com/GitoxideLabs/gitoxide/commit/48417fc8d8d3ec0005ef7b6ef35ced09d92282c2))
    ...
    - Refactor ([`7b307f5`](https://github.com/GitoxideLabs/gitoxide/commit/7b307f5acb7214f4ff674e00167933cdcccc353a))
    ...
    - Avoid shortening absolute paths ([`6106521`](https://github.com/GitoxideLabs/gitoxide/commit/6106521581029c5c24b23a47bb91c1921edfa0af))
    - Add discovery opt env-overrides & env discovery helpers ([`e521d39`](https://github.com/GitoxideLabs/gitoxide/commit/e521d39e1b0f4849280bae1527bf28977eec5093))
    ...
    - Merge branch 'davidkna-discover-x-fs' ([`9abaeda`](https://github.com/GitoxideLabs/gitoxide/commit/9abaeda2d22e2dbb1db1632c6eb637f1458d06e1))
    - Refactor ([`aac5169`](https://github.com/GitoxideLabs/gitoxide/commit/aac5169aa7c753eb3510e61bc01b47a4b7b01c6f))
    - Use `defer` to make dmg unmounting more reliable ([`dbc5caa`](https://github.com/GitoxideLabs/gitoxide/commit/dbc5caa99b050ac7a96cd5e7a73786072c695530))
    - Refactor ([`886e26e`](https://github.com/GitoxideLabs/gitoxide/commit/886e26ee686776ad4caf1864f24cb358432d5c49))
    - Assure cross-fs check doesn't break if cursor is currently empty ([`4546889`](https://github.com/GitoxideLabs/gitoxide/commit/4546889adb87c0d9d1c5d22785240033dc3b0dc2))
    ...
    - Add cross_fs option to upwards discovery ([`277c41f`](https://github.com/GitoxideLabs/gitoxide/commit/277c41f1185398e14f92247aada8422f6b08afd1))
    - Re-enable discovery test on windows thanks to use of `realpath()` ([`1f4ae9e`](https://github.com/GitoxideLabs/gitoxide/commit/1f4ae9e74843d108b261cbfe10e158f74286088a))
    - Fix windows test failure due to //? by ignoring it there. ([`c5fd322`](https://github.com/GitoxideLabs/gitoxide/commit/c5fd3223db73ee61844477aff0e8a2438d9b2e39))
    - Fix windows tests (broke thanks to \\?\), maybe ([`e458b59`](https://github.com/GitoxideLabs/gitoxide/commit/e458b5946ebf01d9f901769b8547df85ef14afcb))
    - Assure ceiling dirs are comparable after absolutize ([`32a157b`](https://github.com/GitoxideLabs/gitoxide/commit/32a157b513191c60795924765825dc7dfb0b38c1))
    ...
    - Refactor ([`895b772`](https://github.com/GitoxideLabs/gitoxide/commit/895b772b5855818ad2227cac8dda0be00f9d5189))
    - Control if at least one ceiling dir has to match using an option ([`ca1f3eb`](https://github.com/GitoxideLabs/gitoxide/commit/ca1f3ebb1306075767597c75bb288a3a0b4ebb41))
    - Revert "remove implicit canonicalization and improve tests" ([`821f3f3`](https://github.com/GitoxideLabs/gitoxide/commit/821f3f383a21ddfd274cb6bdcd2228717cd21942))
    - Refactor ([`6bbc53b`](https://github.com/GitoxideLabs/gitoxide/commit/6bbc53be867e5292a98c422526185c6a4736a6a5))
    ...
    - Fix `special_relative_base` test ([`ae226ba`](https://github.com/GitoxideLabs/gitoxide/commit/ae226ba9c08b04621ce3b42e6972e102d8af2b9c))
    - Remove implicit canonicalization and improve tests ([`cdbb4c9`](https://github.com/GitoxideLabs/gitoxide/commit/cdbb4c9db56ef6eb258a9a76691614d4b45c8d7a))
    - Refactor ([`429446c`](https://github.com/GitoxideLabs/gitoxide/commit/429446c87473dca98bf802fa3de020cb58625f63))
    - Refactor ([`9673aae`](https://github.com/GitoxideLabs/gitoxide/commit/9673aae3da57bc12d45389de3034ab0c2c1c27ab))
    - Some more assertions and ceiling dirs ([`a30bcb8`](https://github.com/GitoxideLabs/gitoxide/commit/a30bcb82413103c69827151f25be0b14b1f04f37))
    - Add ceiling_dirs option to upwards discovery ([`e63e722`](https://github.com/GitoxideLabs/gitoxide/commit/e63e722791a7795cd99048bed834459595c60abc))
    - Declare `git-discover` usable as it's fully documented ([`e439015`](https://github.com/GitoxideLabs/gitoxide/commit/e439015288dad806494e0a2ed8d44fb2247de372))
    ...
    - Thanks clippy ([`7617da0`](https://github.com/GitoxideLabs/gitoxide/commit/7617da002ef5906f858c0cc2c349f442bafd6239))
    - Thanks clippy ([`a084951`](https://github.com/GitoxideLabs/gitoxide/commit/a084951c72818d7cb2061053078793213890c899))
    - Thanks clippy ([`3c9da80`](https://github.com/GitoxideLabs/gitoxide/commit/3c9da80a39bc6638a38868f71d80e2a8ad337a4a))
    - Release git-discover v0.0.0 ([`2b5cf2b`](https://github.com/GitoxideLabs/gitoxide/commit/2b5cf2b95a723d885584ac967cf956c28ea35f47))
</details>
