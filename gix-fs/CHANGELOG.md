 ...
 * **Uncategorized**
    ...
    - Report a non-directory in the path as NotADirectory ([`5cf408b`](https://github.com/GitoxideLabs/gitoxide/commit/5cf408bc6a5267e6e73c43d4a3f86770747e31ba))
...
### Bug Fixes
 ...
 - <csr-id-9197d68ca67817d3fe7d09678562ae6c511e817c/> make sure filesystem capability probing works in worktrees
   ...
   checking `HEAD`, but `gix_discover::repository::Path::LinkedWorkTree`
   stores `git_dir` as `.git/worktrees/<name>` and keeps the actual checkout
   in a separate `work_dir` (`gix-discover/src/repository.rs:64-75,103-106`).
   ...
   such as checkout uses `options.fs.ignore_case` to build path caches
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2484 from GitoxideLabs/improvements ([`470141c`](https://github.com/GitoxideLabs/gitoxide/commit/470141c6fe3529994a97601aeeba6c6d9def1a7b))
    - Merge pull request #2471 from willemneal/feat/wasi-support ([`fb0f694`](https://github.com/GitoxideLabs/gitoxide/commit/fb0f694dae12e2c7249876a165ff20b387edca78))
    - Make sure filesystem capability probing works in worktrees ([`9197d68`](https://github.com/GitoxideLabs/gitoxide/commit/9197d68ca67817d3fe7d09678562ae6c511e817c))
    - Refactor ([`ce9dcd7`](https://github.com/GitoxideLabs/gitoxide/commit/ce9dcd7cb8b502cfdb77bb74a0602852f8509806))
    - Add WASI (wasm32-wasip2) platform support ([`915139f`](https://github.com/GitoxideLabs/gitoxide/commit/915139f1b0d49bd9815ab24c41c08108934c6c28))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2391 from lunbun/typo-gix-fs-dir-create ([`5134b2d`](https://github.com/GitoxideLabs/gitoxide/commit/5134b2d8afbc55726de509e35f1e3ec7fb61dd81))
    - Correct typo in error message for gix-fs directory creation ([`cf83ab4`](https://github.com/GitoxideLabs/gitoxide/commit/cf83ab400dfcaa0152ce002eec3c685e29853305))
...
### New Features
 ...
 - <csr-id-aba8cd427eee65fb6f6b85e56652184616c74f42/> add `Capabilities::probe_dir()` to determine case-sensitivity even if no `.git/config` file is present.
   This costs an extra exists check for file-insensitive directories, but otherwise is optimal.
 ...
 * **Uncategorized**
    ...
    - Add `Capabilities::probe_dir()` to determine case-sensitivity even if no `.git/config` file is present. ([`aba8cd4`](https://github.com/GitoxideLabs/gitoxide/commit/aba8cd427eee65fb6f6b85e56652184616c74f42))
 ...
 * **Uncategorized**
    ...
    - Merge pull request #2284 from isuffix/fix-exec-bit-probe ([`9f49dd3`](https://github.com/GitoxideLabs/gitoxide/commit/9f49dd31559303bf32e0b6e38e0d184ea8a0e7b2))
    - Make clear what the new mode is used for. ([`d8ac7f8`](https://github.com/GitoxideLabs/gitoxide/commit/d8ac7f803c5331f3291a3a1a2fbd411c7e166f9a))
    - Probe executable bits by checking if we can change them ([`9315dbf`](https://github.com/GitoxideLabs/gitoxide/commit/9315dbf9c8853d908cc34350190ced8852313d7d))
 ...
 * **Uncategorized**
    ...
    - `ToNormalPathComponent` now also validates the component if it's not a `Path`. ([`d139fa4`](https://github.com/GitoxideLabs/gitoxide/commit/d139fa469cef4d2a2c351ba4c7f34a090a03c233))
    ...
    - Make `is_executable()` more permissive by taking the group and 'other' permissions into account. ([`8624586`](https://github.com/GitoxideLabs/gitoxide/commit/8624586f4d9df726afe1c6939b952e4241865571))
