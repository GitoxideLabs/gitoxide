 ...
 * **Uncategorized**
    ...
    - Change `Graph::try_lookup_or_insert_default()` to `*::get_or_insert_default()` and `Graph::try_lookup_or_insert_commit()` to `*::get_or_insert_commit()` ([`87217cc`](https://github.com/GitoxideLabs/gitoxide/commit/87217cc43995e6825fddb8af3b64d61f2b3b006a))
    - Add `Graph::get_or_insert_full_commit()` ([`e44c372`](https://github.com/GitoxideLabs/gitoxide/commit/e44c372c64966ee71c0e5890a50f2c4f0aa96ee8))
    - Add `Graph::clear_commit_data()` for when commits are stored and data is attached. ([`1c44e41`](https://github.com/GitoxideLabs/gitoxide/commit/1c44e4166b7f9d6032eab3669f785966d4990b76))
    ...
    - Add `Graph::len()` and `Graph::is_empty()` ([`6d8612c`](https://github.com/GitoxideLabs/gitoxide/commit/6d8612cd530b9b5a037344ae0247e3701b96fdb6))
    - Add `graph::LazyCommit::generation_and_timestamp()` ([`60f0e00`](https://github.com/GitoxideLabs/gitoxide/commit/60f0e00340ec5269918d3b54952bc4d2379e3fb1))
    ...
    - `Graph` now borrows the commitgraph cache. ([`dfedf6a`](https://github.com/GitoxideLabs/gitoxide/commit/dfedf6abf6fc34064ffad6a5f787a49e98d5e022))
    - Add `Graph::insert_parents_with_lookup()` and `Graph::insert_data()`. ([`638ff28`](https://github.com/GitoxideLabs/gitoxide/commit/638ff28644615126f5efdb9bf48d7d3f7ec61b5a))
...
### Changed (BREAKING)
 ...
 - <csr-id-36f70dcb378bff488dc65f0b354c74341b142e7e/> use `gix-object::Find` trait
 ...
 * **Uncategorized**
    ...
    - Add `Queue.len()`. ([`e22ed82`](https://github.com/GitoxideLabs/gitoxide/commit/e22ed826a94463e2095a9817fded52e3a8756a34))
</details>
 ...
 * **Uncategorized**
    ...
    - Allow turning a `Graph` into the underlying map. ([`e4a77aa`](https://github.com/GitoxideLabs/gitoxide/commit/e4a77aab6ba47b7e89d1f020ea500ea7ae057ffe))
    - Merge branch 'future-dates' ([`8d2e6a9`](https://github.com/GitoxideLabs/gitoxide/commit/8d2e6a91ac92a033e9e3daad5cffa90263075536))
    - Remove custom `graph::CommitterTimestamp` in favor of `gix-date::SecondsSinceUnixEpoch`. ([`f4b0195`](https://github.com/GitoxideLabs/gitoxide/commit/f4b0195375db31cc2736fcab9665a0dc2637e74b))
 ...
 * **Uncategorized**
    ...
    - Rename `PriorityQueue::pop()` to `::pop_value()` and add `::pop()` that also pops the key. ([`e920567`](https://github.com/GitoxideLabs/gitoxide/commit/e9205679ab017699fd2605d4211d7ac2528dbc4b))
