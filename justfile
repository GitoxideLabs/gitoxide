...
unit-tests:
    ...
    env GIX_TEST_HASH=sha256 cargo nextest run -p gix-worktree-state-tests --features gix-features-parallel --no-fail-fast
    env GIX_TEST_HASH=sha1 cargo nextest run -p gix-worktree-tests --features gix-features-parallel --no-fail-fast
    env GIX_TEST_HASH=sha256 cargo nextest run -p gix-worktree-tests --features gix-features-parallel --no-fail-fast
    ...
    env GIX_TEST_HASH=sha256 cargo nextest run -p gix-index-tests --features gix-features-parallel --no-fail-fast
