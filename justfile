...
unit-tests:
    ...
    env GIX_TEST_FIXTURE_HASH=sha1 cargo nextest run -p gix-reftable --no-fail-fast
    env GIX_TEST_FIXTURE_HASH=sha256 cargo nextest run -p gix-reftable --no-fail-fast
