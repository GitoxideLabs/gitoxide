...
mod baseline {
    ...
    pub fn run(
        name: &str,
        items_are_dirs: bool,
        init: impl FnOnce() -> Result<(PathBuf, Vec<String>, Vec<Expected>)>,
    ) -> Result {
    ...
    pub fn directories() -> Result<(PathBuf, Vec<String>, Vec<Expected>)> {
    ...
    pub fn files() -> Result<(PathBuf, Vec<String>, Vec<Expected>)> {
